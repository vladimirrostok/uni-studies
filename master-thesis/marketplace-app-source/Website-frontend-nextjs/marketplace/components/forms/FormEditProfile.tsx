...
const FormEditProfile: FC = () => {
  ...
  return (
    ...
    >
      <Box className="flex-col lg:flex-row mt-5">
        <Box className="flex-col lg:w-7/12 lg:mr-10">
          <H2 className="text-sky-500">Profile</H2>
          <Box className="flex-wrap p-10 box_bordered">
          ...
          <H2 className="text-sky-500 mt-5">Images</H2>
          <Box className="flex-col xl:flex-row box_bordered p-5 justify-between">
        ...
        <Box className="flex-col lg:w-5/12">
          <H2 className="text-sky-500">Social</H2>
          <Box className="flex-wrap p-5 box_bordered">
      ...
      <Box className="flex flex-row my-10 mx-auto">
        <SubmitButton type="submit" className="btn_cancel mx-4">
          {"Delete"}
        </SubmitButton>
        {formStatus ? (
          <>
          ...
          <SubmitButton type="submit" className="btn_solid mx-4">
            {"Save"}
          </SubmitButton>
        )}
      </Box>
